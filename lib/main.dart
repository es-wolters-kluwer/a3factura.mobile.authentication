      ...
      ..setNavigationDelegate(
        NavigationDelegate(
          ...
          onPageStarted: (String url) {
            debugPrint('xxxx Page started loading: $url');            
          },
          onPageFinished: (String url) {
            debugPrint('xxx Page finished loading: $url');
          },
...
Page resource error:
  ...
  isForMainFrame: ${error.isForMainFrame}
          ...
          onNavigationRequest: (NavigationRequest request) {
              debugPrint('xxxxx -> blocking navigation to ${request.url}');
          ...
          onUrlChange: (UrlChange change) {
            debugPrint('xxxxx url change to ${change.url}');
          },
      ...
      ..loadRequest(Uri.parse('https://login-integracionesdev.a3software.com/authorize?name=Report&product=a3factura&scope=report'));
  ...
  return showDialog(
   ...
   Future<void> sendPostRequest(String url) async {
      print('xxx sendPostRequest .');

      // Extract the code parameter from the URL
      Uri uri = Uri.parse(url);
      String? code = uri.queryParameters['code'];
      //var urlLocal = Uri.parse("https://login-integracionespre.a3software.com/api/tokens/registerToken?name=Report&code=5ebd6cc6-770f-4c92-a1bf-94d47422811c");
      var urlLocal = Uri.parse("https://login-integracionesdev.a3software.com/api/tokens/registerToken?name=Report&code=$code");
      var response = await http.get(urlLocal);
      var json = response.body;
      print('xxx http response : $json ');
      openDialog2(json, url +" - https://login-integracionesdev.a3software.com/api/tokens/registerToken?name=Report&code=$code" );
  }
}
